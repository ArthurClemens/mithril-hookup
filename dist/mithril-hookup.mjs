...
const createComponent = component => hookup((vnode, hooks) => component({
  hooks
})(vnode.attrs));
const withCustomHooks = customHooks => component => (_ref) => {
  let hooks = _ref.hooks;
  return component({
    hooks: _objectSpread({}, hooks, customHooks(hooks))
  });
};
